{{--  <table border="1">
    ...
    <tr>
        ...
        <td>
            Estos son los cuyos que tenemos disponibles
        </td>
    </tr>
</table> --}}
...
{{--  <html>
    ...
    <body>
	    <h1> Estos son los cuyos que tenemos: </h1> <br>
    ...
    <div class="p-6 bg-gray-50 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-full">
        ...
        <p class="mb-2">Esto es un centro de adopcion y compra de cuyos. Obtiene la mascota perfecta para toda edad</p>
        <p>En este perfil podras encontrar diferentes ejemplares y podras adoptar cuando quieras.</p> 
    </div>
    </div>
...
{{-- <html>
    ...
    <body>
	    <h1 class="contenido"> Estos son los cuyos que tenemos: </h1> 
        <h1 class="titulo"> Estos son los cuyos </h1>
...
<html>
    ...
    <body> <br>
	    <h1 class="contenido"> hola estoy desde la primera forma de componentes en CUYO</h1> 
